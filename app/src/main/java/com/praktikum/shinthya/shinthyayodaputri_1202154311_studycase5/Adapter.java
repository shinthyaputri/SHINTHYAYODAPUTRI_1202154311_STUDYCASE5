...
public class Adapter extends RecyclerView.Adapter<Adapter.holder> {
    //deklarasi variable yang akan digunakan private context cntx, private List<AddData> list, int color
    private Context cntx;
    private List<AddData> list;
    int color;

    //konstruktor membuat adapter cntx,list,color
    ...
    public holder onCreateViewHolder(ViewGroup parent, int viewType) {
        //membuat view baru View view = LayoutInflater.from(cntx).inflate(R.layout.cardview_list, parent, false);
        View view = LayoutInflater.from(cntx).inflate(R.layout.cardview_list, parent, false);
        //membuat holder baru yg bernama hldr
    ...
    class holder extends RecyclerView.ViewHolder{
        //deklarasi variable yang akan digunakan TextView. textview isinya ada todoo, deskripsi, prioritas (in english), cardview, dan holder
